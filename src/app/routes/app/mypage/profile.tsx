...
const ProfileRoute = () => {
  ...
  const gitRepoUrl =
    gitAccount && gitRepository ? `https://github.com/${gitAccount}/${gitRepository}` : ''
  ...
  return (
    ...
    >
      ...
      <p>
        <strong>GitHub アカウント名:</strong> {gitAccount}
      </p>
      {gitRepoUrl && (
        <p>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        ...
        <button onClick={handleSignOut} style={buttonStyle('#dc3545', '#a71d2a')}>
          サインアウト
        </button>
      </div>
    </div>
