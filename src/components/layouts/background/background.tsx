    ...
    <div className="back-img">
      ...
      <div className="icons-container">
        <div className="icons-gomi">
          ...
          <img src={icon.gomibako} onClick={handleSignOut} alt="ゴミ箱" />
        </div>
        <div className="icons-home">
          <p className="speech-bubble">ホーム</p>
          <img src={icon.home} onClick={() => handleClick('home')} alt="ホーム" />
        </div>
        <div className="icons-mail">
          <p className="speech-bubble">メール</p>
          <img src={icon.mail} onClick={() => handleClick('mail')} alt="メール" />
        </div>
        <div className="icons-mypage">
          <p className="speech-bubble">マイページ</p>
          <img src={icon.mypage} onClick={() => handleClick('mypage')} alt="マイページ" />
        </div>
        <div className="icons-file">
          <p className="speech-bubble">ファイル</p>
          <img src={icon.file} onClick={() => handleClick('file')} alt="ファイル" />
        </div>
        <div className="icons-editor">
          <p className="speech-bubble">エディタ</p>
          <img src={icon.editor} onClick={() => handleClick('editor')} alt="エディタ" />
        </div>
        <div className="icons-yomi">
          <p className="speech-bubble">教材</p>
          <img src={icon.yomimono} onClick={() => handleClick('material')} alt="読み物" />
        </div>
        <div className="icons-sett">
          <p className="speech-bubble">設定</p>
          <img src={icon.settings} onClick={() => handleClick('settings')} alt="設定" />
        </div>
