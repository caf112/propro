...
//       const res = await fetch("https://myt58d8k6k.execute-api.ap-northeast-1.amazonaws.com/production");
...
//     const socket = new WebSocket("wss://vk14160bx5.execute-api.ap-northeast-1.amazonaws.com/production/");
