...
const processOnEvent = async (event, context) => {
  ...
  switch (event.RequestType) {
    ...
    case 'Update':
      ...
      const describePointInTimeRecoveryResult = await ddbClient.describeContinuousBackups({
        TableName: event.PhysicalResourceId,
      })
    ...
    case 'Delete':
      ...
      try {
        ...
        if (
          (_b = describeTableResultBeforeDeletion.Table) === null || _b === void 0
            ? void 0
...
const processIsComplete = async (event, context) => {
  ...
  const describeTableResult = await retry(
    ...
    (result) => !!(result === null || result === void 0 ? void 0 : result.Table),
  )
  if (
    ((_a = describeTableResult.Table) === null || _a === void 0 ? void 0 : _a.TableStatus) !==
    'ACTIVE'
  ) {
  ...
  if (
    (_b = describeTableResult.Table.GlobalSecondaryIndexes) === null || _b === void 0
      ? void 0
  ...
  if (
    ...
    ((_c = event.Data) === null || _c === void 0 ? void 0 : _c.IsTableReplaced) === true
  ) {
    const describePointInTimeRecoveryResult = await ddbClient.describeContinuousBackups({
      TableName: event.PhysicalResourceId,
    })
...
const getNextAtomicUpdate = (currentState, endState) => {
  ...
  const isTableBillingModeModified =
    ...
    (((_c = currentState.BillingModeSummary) === null || _c === void 0 ? void 0 : _c.BillingMode) ==
      undefined &&
...
const getNextGSIUpdate = (currentState, endState) => {
  ...
  const gsiRequiresUpdatePredicate = (endStateGSI) => {
    ...
    if (
      ...
      if (currentStateGSI) {
        if (
          ((_a = currentStateGSI.ProvisionedThroughput) === null || _a === void 0
            ? void 0
            : _a.ReadCapacityUnits) !==
            ((_b = endStateGSI.provisionedThroughput) === null || _b === void 0
              ? void 0
              : _b.readCapacityUnits) ||
          ((_c = currentStateGSI.ProvisionedThroughput) === null || _c === void 0
            ? void 0
      ...
      GlobalSecondaryIndexUpdates: [
        {
          Update: {
            ...
            ProvisionedThroughput: {
              ReadCapacityUnits:
                (_d = gsiToUpdate.provisionedThroughput) === null || _d === void 0
                  ? void 0
                  : _d.readCapacityUnits,
              WriteCapacityUnits:
                (_e = gsiToUpdate.provisionedThroughput) === null || _e === void 0
                  ? void 0
...
const getStreamUpdate = async (currentState, endState) => {
  ...
  let streamUpdate
  if (
    ((_a = endState.streamSpecification) === null || _a === void 0 ? void 0 : _a.streamViewType) !==
      undefined &&
    ...
    ((_b = endState.streamSpecification) === null || _b === void 0 ? void 0 : _b.streamViewType) ===
      undefined &&
    ...
    ((_e = endState.streamSpecification) === null || _e === void 0 ? void 0 : _e.streamViewType) !==
      undefined &&
    currentState.StreamSpecification.StreamViewType !==
      ((_f = endState.streamSpecification) === null || _f === void 0 ? void 0 : _f.streamViewType)
  ) {
...
const getSseUpdate = (currentState, endState) => {
  ...
  if (currentState.SSEDescription) {
    if (!((_a = endState.sseSpecification) === null || _a === void 0 ? void 0 : _a.sseEnabled)) {
      ...
      ((_b = endState.sseSpecification) === null || _b === void 0 ? void 0 : _b.sseEnabled) ===
        true &&
...
const requiresTagsUpdate = (currentTags, newTags) => {
  ...
  for (const newTag of newTags) {
    if (!currentTags.find((currentTag) => currentTag.Key === newTag.Key)) {
      ...
      if (
        (currentTag === null || currentTag === void 0 ? void 0 : currentTag.Value) !== newTag.Value
      ) {
        return true
      }
    }
...
const getDeletionProtectionUpdate = (currentState, endState) => {
  if (
    ...
    currentState.DeletionProtectionEnabled !== endState.deletionProtectionEnabled
  ) {
    return {
      TableName: currentState.TableName,
...
const getPointInTimeRecoveryUpdate = (currentPointInTime, endState) => {
  ...
  const currentStatus =
    (_a = currentPointInTime.PointInTimeRecoveryDescription) === null || _a === void 0
      ? void 0
...
const createNewTable = async (input) => {
  ...
  return {
    ...
    streamArn:
      (_a = result.TableDescription) === null || _a === void 0 ? void 0 : _a.LatestStreamArn,
  }
}
...
const isProjectionModified = (currentProjection, endProjection) => {
  ...
  if (
    currentNonKeyAttributes.some(
      (currentNonKeyAttribute) => !endNonKeyAttributes.includes(currentNonKeyAttribute),
    )
  )
    return true
  return false
...
const isKeySchemaModified = (currentSchema, endSchema) => {
  ...
  if (
    ...
    (endHashKey === null || endHashKey === void 0 ? void 0 : endHashKey.attributeName)
  )
    return true
  ...
  if (
    ...
    (endSortKey === null || endSortKey === void 0 ? void 0 : endSortKey.attributeName)
  )
    return true
  return false
}
